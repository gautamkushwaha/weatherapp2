...
export default function weather({ data }) {
  ...
  return (
    <div className='relative flex flex-col justify-between max-w-[500px] w-full h-[90vh] m-auto p-4 text-gray-300 z-10 mb-10'>
      {/* top */}
      ...
      {/* Bottom */}
      <div className='bg-black/50 relative rounded-md w-[100%] mb-20 p-10'>
